...
namespace MassEffect.GameObjects.Ships
{
    public abstract class StarShip : IStarship
    {
        ...
        public override string ToString()
        {
            ...
            starShip.AppendLine(string.Format("--{0} - {1}", this.Name, this.shipType))
                ...
                .AppendLine(string.Format("-Fuel: {0:f1}", this.Fuel))
                .Append(string.Format("-Enhancements: {0}", _enhancements.Count == 0 ? "N/A" : ""))
                .Append(String.Join(", ", this.Enhancements.Select(s => s.Name)));
